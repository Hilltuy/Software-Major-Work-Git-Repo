#UI classes from https://github.com/Carberra/pygame-tutorial/blob/main/snek/ui.py
#Some modifications made by me in order to fit with how my project handles classes
import pygame as pg
...
class Text:
    ...
    def __init__(self, body, x, y, size, align="topleft", colour=(255, 255, 255)):
        ...
        self.size = size
        self.align = align
        self.font = pg.font.SysFont('Helvetica',size) 
        self.renders = []
        self.render()
